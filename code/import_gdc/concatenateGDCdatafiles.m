function [primtumor_joined, norm_joined]= concatenateGDCdatafiles(params)
...
fprintf(['[concatGDCdata]: primtumor loaded from "',params.primtumor_datapath,'"\n']);

%% Load from files
if ~isempty(dir([params.savefilepath,'primtumor.mat'])) && ...
   ~isempty(dir([params.savefilepath,'norm.mat'])) && ~params.reimport
