...
Significance_log10= round(log10(pvals(upmir)),3,'significant');
...
updata= table(Upregulated_miR,Significance_log10,Coverage,Inc_Coverage,Mean_Fold_change,Mean_Tumor_Reads_per_million,Mean_Normal_Reads_per_million);

Significance_log10= round(log10(pvals(downmir)),3,'significant');
...
downdata= table(Downregulated_miR,Significance_log10,Coverage,Inc_Coverage,Mean_Fold_change,Mean_Tumor_Reads_per_million,Mean_Normal_Reads_per_million);
